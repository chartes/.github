...
### 📜 Applications & ressources / Applications & Resources

- [Applications, éditions et jeux de données | Applications, Scholarly Editions, and Datasets](https://www.chartes.psl.eu/recherche/applications-editions-et-jeux-de-donnees)

### 🤗 ENC-PSL organisation sur Hugging Face / ENC-PSL organisation on Hugging Face

- [Organisation Hugging Face](https://huggingface.co/ENC-PSL)

### ⚙️ Stack technique / Dev Stack
